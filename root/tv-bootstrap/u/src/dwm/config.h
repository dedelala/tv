...
static const char col_pink[]        = "#ffafc7";
static const char col_blue[]        = "#74d7ec";
static const char col_white[]       = "#fbf9f5";
static const char col_dark[]       = "#1b1915";
static const char *colors[][3]      = {
	/*               fg        bg        border   */
	[SchemeNorm] = { col_blue, col_dark, col_blue },
	[SchemeSel]  = { col_pink, col_dark, col_pink },
};

/* tagging */
static const char *tags[] = { "fox", "snd" };
